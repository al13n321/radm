...
\paragraph{}
% TODO: detailed explanation: why this mathematical formulation of the stated problem is equivalent to the real-world one.
% For example: what is cut equivalent in real life, justify the choosing of sink and source, explain why THIS solution is mimimal cost.
...
\paragraph{}
The flow (which is also a transportation plan) is shown in figure \ref{flow3-1a}. The minimum total cost is \texteuro 578,535. The number of remaining spools is shown in table \ref{spools-left}.
...
\paragraph{}
% TODO: explain why increasing the cost by the upper tolerance leaves it in the solution
...
\paragraph{}
% TODO: explain the changes to the algorithm/solution/graph that appeared after adding new constraints.
The new plan is shown in figure \ref{flow3-1c}. Its cost is \texteuro 658,175.
