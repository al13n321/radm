...
\paragraph{}
We reversed the direction of the corresponding arc and found the cut again. The optimal checkpoint locations are shown in table \ref{mincut3-6b}. Apparently, the cut is trivial: no one can leave X without passing a checkpoint. The total cost is \texteuro 1,500,000.
